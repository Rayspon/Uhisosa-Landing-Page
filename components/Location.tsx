    ...
    <div className="max-w-screen-xl mx-auto px-6">
      <div className="flex flex-col lg:flex-row gap-16 items-start">
        <div className="lg:w-1/3 pt-12">
          <span className="text-primary font-black uppercase tracking-widest text-sm mb-4 block">{t.location.badge}</span>
          ...
          <div className="space-y-10">
            <div>
               <h4 className="text-xs font-black text-gray-400 uppercase tracking-[0.2em] mb-3">{t.location.addressLabel}</h4>
